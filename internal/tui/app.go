	...
	return func() tea.Msg {
		...
		for _, n := range m.cfg.Containers.Names {
			...
			cmds = append(cmds, func() tea.Msg {
				...
				if err != nil {
					return WorkerStatusMsg{nc, true, "0%", "0MB", ct.Status}
				}
...
func (m *AppModel) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	if m.logModel != nil {
		switch msg.(type) {
		case LogEntryMsg, logStreamsClosedMsg:
			_, cmd := m.logModel.Update(msg)
			return m, cmd
		}
	}
